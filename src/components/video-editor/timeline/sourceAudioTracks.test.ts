...
describe("timeline source audio tracks", () => {
	it("builds candidates for Windows and macOS sidecar containers", () => {
		expect(buildSourceSidecarPathCandidates("C:\\Rendr\\recording-1.mp4", "mic")).toEqual([
			"C:/Rendr/recording-1.mic.wav",
			"C:/Rendr/recording-1.mic.m4a",
			"C:/Rendr/recording-1.mic.webm",
		]);
	});
