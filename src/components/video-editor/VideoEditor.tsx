...
import { useAgentTools } from "@/lib/agent/useAgentTools";
import {
...
export default function VideoEditor() {
	...
	// Agent surface: this window hosts the editor half of the MCP tool set.
	// Zoom tools call the same setZoomRegions the UI does, so agent and human
	// edits share one mutation path and one history.
	useAgentTools({
		editor: () => ({
					...
					<DialogHeader>
						...
						<DialogDescription className="text-muted-foreground">
							{t(
								...
								"Name this project. It will be saved in your Rendr Projects folder.",
							)}
						</DialogDescription>
					</DialogHeader>
					<div className="py-4">
				...
				<DialogHeader>
					...
					<DialogDescription className="text-muted-foreground">
						{t(
							...
							"Your device does not support native capture. This could be for a variety of reasons we haven’t figured out yet. This doesn’t break Rendr, but it does make cursor smoothing impossible.",
						)}
					</DialogDescription>
				</DialogHeader>
				<DialogFooter>
